...
def kitti11():
	...
	cv2.imwrite("theshold_Matches_Kitti11.png", kitti11_theshold_matches)
	print ("Anzahl Matches Kitti11 mit theshold 0.7: " + str(len(matches)))
...
def kitti14():
	...
	cv2.imwrite("theshold_Matches_Kitti14.png", kitti14_theshold_matches)
	print ("Anzahl Matches Kitti14 mit theshold 0.7: " + str(len(matches)))
